...
const { listTeams, createTeam, getTeam, updateTeam, destroyTeam, addMember, removeMember, updateMembers, getTags, updateTags } = require('./teams')
...
function manageRouter (nextApp) {
  ...
  router.get('/api/teams/tags', getTags)
  ...
  router.put('/api/teams/:id/tags', can('team:update'), updateTags)
